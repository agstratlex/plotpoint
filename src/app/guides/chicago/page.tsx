          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="mt-10 flex flex-wrap gap-4 justify-center lg:justify-start">
                <button className="group inline-flex items-center gap-2.5 px-8 py-3.5 rounded-full bg-lime hover:bg-chartreuse text-charcoal font-sub font-bold text-sm uppercase tracking-wider transition-all neon-border-lime hover:scale-[1.02]">
